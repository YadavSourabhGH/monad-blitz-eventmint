              ...
              <div className="event-details-card">
                ...
                <div className="ticket-info">
                  <div className="price-tag">
                    ...
                    <span className="price-value">{event.ticketPrice} MON</span>
                  </div>
          ...
          <div className="modal-purchase" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="purchase-summary">
              <div className="summary-row">
                ...
                <strong>{selectedEvent.ticketPrice} MON</strong>
              </div>
              <div className="summary-row">
                <span>Gas Fee:</span>
                <span className="estimate">~0.001 MON (estimate)</span>
              </div>
              <div className="summary-row total">
                <span>Total:</span>
                <strong>~{(parseFloat(selectedEvent.ticketPrice) + 0.001).toFixed(4)} MON</strong>
              </div>
            </div>
